export const test5 = [
  ...
  {
    question: "Which of the following is a typical use case for a queue?",
    options: [
      "Undo functionality in text editors",
      "Resource scheduling in operating systems",
      "Postfix expression evaluation",
      "Accessing elements from an ordered collection",
    ],
    correctAnswer: "Resource scheduling in operating systems",
    explanation:
      "Queues are commonly used for resource scheduling in operating systems, where processes are handled in a FIFO manner.",
  },
];
